...
<<<<<<< HEAD
    <form method="POST" action="?page=login-auth"
        style="background:#1b1b1b; padding:40px; border-radius:12px; width:350px; box-shadow:0 0 12px rgba(0,0,0,0.4);">

=======
    <form method="POST" action="?page=login&aksi=auth" style="background:#1b1b1b; padding:40px; border-radius:12px; width:350px; box-shadow:0 0 12px rgba(0,0,0,0.4);">
