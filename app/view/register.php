...
<div style="display:flex; justify-content:center; align-items:center; height:100vh;">
    <form method="POST" action="?page=register&aksi=store" style="background:#1b1b1b; padding:40px; border-radius:12px; width:350px; box-shadow:0 0 12px rgba(0,0,0,0.4);">
        <h2 style="margin-bottom:25px; color:gold; text-align:center;">Daftar Akun</h2>
